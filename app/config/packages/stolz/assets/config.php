	...
	*/
	...
	'collections' => array(
		...
		'bootstrap'	=> array(
            ...
            'http://'.Request::server('HTTP_HOST').'/assets/css/bootstrap.css',
            'http://'.Request::server('HTTP_HOST').'/assets/css/jasny-bootstrap.css',
            'http://'.Request::server('HTTP_HOST').'/assets/css/font-awesome.css',

            'http://'.Request::server('HTTP_HOST').'/assets/css/bootstrap-formhelpers.css',
            'http://'.Request::server('HTTP_HOST').'/assets/css/selectize.bootstrap3.css',


            'http://'.Request::server('HTTP_HOST').'/assets/js/bootstrap.js',
            'http://'.Request::server('HTTP_HOST').'/assets/js/jasny-bootstrap.js',

            'http://'.Request::server('HTTP_HOST').'/assets/js/bootstrap-formhelpers.js',
            'http://'.Request::server('HTTP_HOST').'/assets/js/selectize.min.js',
            'http://'.Request::server('HTTP_HOST').'/assets/js/frontend-app.js',
		),

		'admin' => array(
            'http://'.Request::server('HTTP_HOST').'/assets/css/multi-select.css',

            'http://'.Request::server('HTTP_HOST').'/assets/js/jquery.multi-select.js',
            'http://'.Request::server('HTTP_HOST').'/assets/js/admin-app.js',
            'http://'.Request::server('HTTP_HOST').'/assets/js/jquery.tablednd.js',
		)
	),
